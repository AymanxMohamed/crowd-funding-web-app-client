...
const ProjectHeader: React.FC<any> = ({ project }): JSX.Element => {
  return (
        ...
        <div className="mx-auto py-8 px-4 sm:py-12 sm:px-6 lg:max-w-full lg:px-8">
          ...
          <div className="lg:grid lg:grid-rows-1 lg:grid-cols-7 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
            ...
            <div className="lg:row-end-1 lg:col-span-4">
              <div className="aspect-w-6 aspect-h-3 rounded-lg justify-center overflow-hidden">
                <Carousel autoPlay={false} showStatus={false} showThumbs={false} transitionTime={500}>
