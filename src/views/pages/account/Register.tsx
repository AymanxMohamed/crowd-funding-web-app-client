            ...
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-sm mx-auto">
                <form>
                  ...
                  <TextInput label="Password Confirmation" name="email" placeholder="Enter Your Password"
                             type="password"/>
                  ...
                  <div className="flex flex-wrap -mx-3 mb-3">
                    <div className="w-full px-3">
                      <button
                        ...
                        <svg className="w-4 h-4 fill-current text-white opacity-75 flex-shrink-0 mx-4"
