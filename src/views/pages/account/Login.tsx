  ...
  return (
    <Wrapper>
      ...
      <div className="max-w-sm mx-auto">
        <form>
          <TextInput label="Email" value={formData.email} name="email" placeholder="Enter Your Email"
                     type="email" onChange={handleEmailChange}/>
          <TextInput label="Password" value={formData.password} name="email" placeholder="Enter Your Password"
                     type="password" onChange={handlePasswordChange}/>
          <Checkbox label="Keep me signed in" checked={formData.remember} onChange={handleRememberMeChange}/>
        ...
        <div className="text-gray-600 text-center mt-6">
          Don’t you have an account? <Link to="/account/register"
